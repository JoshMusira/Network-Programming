...
const QueryPrint = () => {
    ...
    return (
        <div className=" flex items-center flex-col justify-center py-3 px-4 sm:px-6 lg:px-8">
            <div className='fex  w-full shadow-sm shadow-white rounded-lg p-2 justify-around items-start'>
                ...
                <div className="mt-1  border-b-white flex  w-full justify-around pb-2  space-y-2">
                    <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="sports_print" className="ml-3 block text-sm font-semibold text-white">
                            Sports Database
                        </label>
                    </div>
                    <div className="flex items-center">
                        <input
                            ...
                            name="database"
                            type="radio"
                            value="politics_print"
                            onChange={handleDatabaseChange}
                            className="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300"
                        />
                        <label htmlFor="politics_print" className="ml-3 block text-sm font-semibold text-white">
                    ...
                    <div className="flex items-center">
                        <input
                            ...
                            name="database"
                            type="radio"
                            value="industry_print"
                            onChange={handleDatabaseChange}
                            className="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300"
                        />
                        <label htmlFor="industry_print" className="ml-3 block text-sm font-semibold text-white">
            ...
            <div className="max-w-[95%] w-full space-y-3 p-2 bg-gray-400 rounded-xl shadow-lg z-10">

                <div className="text-center">
                    <h1 className="text-3xl font-bold text-blue-700">Query Print Database</h1>
                </div>
            ...
            {answer && (
                <div className="mt-4 p-4 border border-gray-400 w-[99%] rounded-md bg-black">
                    ...
                    <ReactMarkdown className="flex justify-start text-start text-xl flex-col py-2 text-gray-400 items-start leading-7">{answer}</ReactMarkdown>
                </div>
            )}
            {isComplete && (
